...
function App() {
  return (
    <div className='bg-gray-400 min-h-screen p-8 flex flex-col items-center'>
      <h1 className="text-4xl font-bold text-black-500 mb-10">오늘의 주식 시세</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full max-2-7xl">
        {
          stocks.map(stock => (
            <TickerCard 
              key={stock.ticker} 
